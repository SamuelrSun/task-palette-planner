  ...
  return (
    <div className="w-[450px] border-r border-gray-200 p-6">
      ...
      <div className="flex space-x-3">
        ...
        <Button className="flex-1 bg-purple-500 hover:bg-purple-600">Generate</Button>
      </div>
    </div>
  );
};
...
const EmployeeItem: React.FC<EmployeeItemProps> = ({ name, status, avatarColor }) => {
  return (
    <div className="flex items-center justify-between p-3 border border-gray-200 rounded-md">
      <div className="flex items-center">
        <div className={`w-8 h-8 rounded-full ${avatarColor} flex items-center justify-center text-white mr-3`}>
          {name.charAt(0)}
        </div>
        <div>
